...
## 25.03.2025 - Реализация системы учета зарплат сотрудников

### Добавлено:
- Модели `Salary` и `SalaryPayment` в Prisma схеме
- API-роутер для работы с зарплатами (`salary.ts`)
- Страница для управления зарплатами сотрудников (`/salary`)

### Функциональность:
- Полная информация о сотрудниках: ФИО, должность, дата начала работы
- Управление выплатами: день/месяц выплаты, фиксированная/нефиксированная зарплата
- История выплат с возможностью добавления новых выплат и комментариев к ним
- Поиск сотрудников по ФИО и должности
- Пагинация результатов

### Технические детали:
- Реактивное обновление данных при добавлении сотрудников и выплат
